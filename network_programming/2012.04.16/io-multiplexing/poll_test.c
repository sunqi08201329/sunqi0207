...
int init_conn_list(int n)
{
  global_conn_list = (conn_t **) utils_safe_malloc(n * sizeof(conn_t *));
...
conn_t *create_conn_object(void)
{
  conn_t *c = (conn_t *) utils_safe_malloc(sizeof(conn_t));
...
buffer_t *create_buffer_object(void)
{
  buffer_t *buf = (buffer_t *) utils_safe_malloc(sizeof(buffer_t));
  ...
  buf->data = (char *) utils_safe_malloc(BUFFER_SIZE);
